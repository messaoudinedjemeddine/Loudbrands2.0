...
// TikTok Pixel base code is in root layout <head> (pixel ID D26J6SJC77UB6AOKBFTG); SubmitOrder on order-success page
    ...
    return (
        <>
          ...
          `,
            ...
            {/* TikTok Pixel base code is in root layout <head> for TikTok verification; ttq is available globally for order-success SubmitOrder */}
        </>
    )
}
