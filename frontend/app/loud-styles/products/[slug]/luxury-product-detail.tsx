            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center space-x-4">
                <Button
                  ...
                  className={`text-muted-foreground hover:text-foreground dark:text-gray-300 dark:hover:text-white ${isInWishlist(product.id) ? 'text-red-500 dark:text-red-400' : ''
                    }`}
                >
                ...
                {product.images.length > 1 && (
                  ...
                  >
                    {product.images.map((image, index) => (
                      <motion.button
                        key={index}
                        className={`relative aspect-square w-16 sm:w-20 rounded-lg overflow-hidden border-2 transition-all duration-300 flex-shrink-0 ${index === currentImageIndex
