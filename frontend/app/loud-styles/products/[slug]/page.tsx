...
import { ProductDetailSkeleton } from '@/components/loading-skeleton-product'
import dynamic from 'next/dynamic'

// Lazy load the heavy product detail component
const LuxuryProductDetail = dynamic(() => import('./luxury-product-detail'), {
